...
import { Eye, EyeOff, Loader2, PawPrint, Mail, Lock } from "lucide-react"
      ...
      >
        <div className="mx-auto grid w-full max-w-[400px] gap-6">
              ...
              <form onSubmit={handleSubmit} className="grid gap-5">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <Link
                      href="#"
                      className="ml-auto inline-block text-sm text-orange-600 hover:text-orange-700 hover:underline transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
          ...
          <div className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="font-medium text-orange-600 hover:text-orange-500 hover:underline transition-colors">
              Sign up now
            </Link>
          </div>
      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full p-12 text-white">
          <div className="max-w-md text-center">
            ...
            >
              Track vaccinations, set reminders, and keep all your pet's information in one secure place.
            </motion.p>
            <motion.div 
            ...
            >
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 text-center">
                ...
                <p className="text-sm">Happy Pet Owners</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 text-center">
                <h3 className="text-2xl font-bold">50+</h3>
                <p className="text-sm">Unique Features</p>
              </div>
            </motion.div>
          </div>
        </div>
